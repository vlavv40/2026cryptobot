...
class Config:
    ...
    NEWS_SENTIMENT_WARN_THRESHOLD = int(os.getenv("NEWS_SENTIMENT_WARN_THRESHOLD", "3"))
    NEWS_SENTIMENT_BLOCK_THRESHOLD = int(os.getenv("NEWS_SENTIMENT_BLOCK_THRESHOLD", "6"))
    NEWS_SENTIMENT_CRITICAL_THRESHOLD = int(os.getenv("NEWS_SENTIMENT_CRITICAL_THRESHOLD", "10"))
